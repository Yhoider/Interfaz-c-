...
namespace Interfaz
{
    public partial class Crear_cuenta : Form
    {
        ...
        // Constructor del formulario Crear_cuenta, que inicializa los componentes de la interfaz.
        public Crear_cuenta()
        {
        ...
        // Método que maneja la creación de la cuenta cuando el usuario hace clic en el botón "Crear cuenta".
        private void button1_Click(object sender, EventArgs e)
        {
            // Intenta crear la cuenta con el nombre de usuario y la contraseña proporcionados.
            bool creada = SistemaUsuarios.CrearCuenta(txtuser.Text, txtpassword.Text);

            if (creada) // Si la cuenta fue creada exitosamente.
            {
                MessageBox.Show("Cuenta creada exitosamente."); // Muestra un mensaje de éxito.
                ...
                this.Hide(); // Oculta el formulario de creación de cuenta.
            }
            else
            {
                MessageBox.Show("El usuario ya existe."); // Muestra un mensaje de error si el usuario ya está registrado.
            }
        }
